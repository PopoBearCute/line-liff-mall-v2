...
export function Header({ isLeader, onHome }: HeaderProps) {
  return (
    <div className="fixed top-4 right-4 z-[50]">
      ...
      >
        <div className="bg-white p-2 rounded-full shadow-md border border-slate-100 group-hover:border-blue-200 transition-colors flex items-center justify-center">
