...
const GAS_URL = process.env.NEXT_PUBLIC_GAS_URL || "https://script.google.com/macros/s/AKfycbxKORHyiPJY-01jo5r2dWCNoFegCby6v7AXGgOJ6kuuerEFQCQGdVQT_sB6-Ga0pC-B/exec";
