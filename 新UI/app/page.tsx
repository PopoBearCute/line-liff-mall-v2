...
const GAS_URL = process.env.NEXT_PUBLIC_GAS_URL || "https://script.google.com/macros/s/AKfycbxpnWKVXF563RG0qrIVCldb-RIhrgN3pGvJsTMzM4TDYiTp08H6TACZ1pAd-u3BgiiiAA/exec";
