...
const GAS_URL = process.env.NEXT_PUBLIC_GAS_URL || "https://script.google.com/macros/s/AKfycbylQ5sfpywrniXyfcRuWfEhUYcqdCVZdAOyPQjes9pSbgr9GYFllCopww6QNWJ1-nHPqA/exec";
