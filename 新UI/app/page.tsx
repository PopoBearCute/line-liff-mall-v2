...
const GAS_URL = process.env.NEXT_PUBLIC_GAS_URL || "https://script.google.com/macros/s/AKfycbwPl-X2nswIUOetDWJ1RqOYEbt0Jbleex-dUbqoYa1lJObvBLFx7QwrU4yxrKo7r_fdvQ/exec";
